...
This Page, our website and app gathers important information from its visitors and customers. This Privacy Policy is published to communicate how the information about the page&#39;s users is gathered, used and protected. Any services provided to you by our web-page are subject to this Privacy Policy.

 References in the Privacy Policy to &quot;Artsflow&quot;or similar refer to this page, our website artsflow.com , our mobile application and any of its affiliates.

Any client or visitor, by using Artsflow and using our services agrees to this Privacy Policy our Cookies Policy (below) and our Terms and Conditions. If you do not agree to this Privacy Policy, you must stop using Artsflow.

We use your data to provide and improve our services. By using the services, you agree to the collection and use of information in accordance with this Policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible via artsflow.com.

This Privacy Policy applies to any and all of the services accessible through the app (&quot;Services&quot;) that are available, unless it is expressly stated that a separate privacy policy applies to a particular Service, in which case that other privacy policy only applies. This Policy sets out the basis on which any personal data we collect from you, or that you provide to us, will be processed by us.
...
**App platform/store:** Any website or platform, from which our website and mobile application can be downloaded (termed &quot;App Site&quot; in this Policy) might be owned or operated by another corporate body for whom the software supplier developed the mobile app. This could be a smartphone manufacturer or a mobile network operator or, more typically, a distribution platform (termed an &quot;Appstore&quot; in this Policy). **You are responsible for making sure that you have also read and understood the relevant Apps Site&#39;s or the Appstore&#39;s Privacy Policy as well as our Policy.**
...
E-mail: [hello@artsflow.com](mailto:hello@artsflow.com)

**The GDPR**
 Artsflow LTD, which operates artsflow.com, is a company incorporated and located in the United Kingdom and is subject to the UK laws.
...
You may do so by reading this Privacy Policy and contacting us at: [hello@artsflow.com](mailto:hello@artsflow.com)
...
Please contact us at [hello@artsflow.com](mailto:hello@artsflow.com) .
...
You can find out more about cookies at [www.allaboutcookies.org](http://www.allaboutcookies.org/). and [www.aboutcookies.org](http://www.aboutcookies.org/).
...
- Our service providers use cookies and those cookies may be stored on your computer when you visit our website and mobile application.
- We use Google Analytics to analyse the use of our website and mobile application. Google Analytics gathers information about app use by means of cookies. The information gathered relating to our website and mobile application is used to create reports about the use of our website and mobile application. Google&#39;s privacy policy is available at: [https://www.google.com/policies/privacy/](https://www.google.com/policies/privacy/). The relevant cookies are: Google Analytics Tracking Code.
...
- A number of apps provide detailed information on cookies, including [AboutCookies.org](http://www.aboutcookies.org/) and [AllAboutCookies.org](http://www.allaboutcookies.org/).
- The European Interactive Digital Advertising Alliance app [Your Online Choices](http://www.youronlinechoices.com/uk) allows you to install opt-out cookies across different advertising networks.
- Google has developed a browser add-on to allow users to [opt-out of Google Analytics](http://tools.google.com/dlpage/gaoptout) across all apps which use it. This is also [available in the Chrome web store](https://chrome.google.com/webstore/detail/google-analytics-opt-out/fllaojicojecljbmefodhfapmkghcbnh?hl=en).
- Some browsers include a feature known as &#39;Do Not Track&#39; or DNT. This allows you to indicate a preference that apps should not track you. However, whilst DNT is available in many browsers, apps are not required to recognise its request, so it may not always work. You can get help on how to use DNT in [Microsoft Edge](https://privacy.microsoft.com/en-us/windows-10-microsoft-edge-and-privacy), [Internet Explorer](https://support.microsoft.com/en-gb/help/17288/windows-internet-explorer-11-use-do-not-track), [Firefox](https://support.mozilla.org/en-US/kb/settings-privacy-browsing-history-do-not-track), Chrome, [Safari](https://support.apple.com/en-gb/guide/safari/prevent-websites-from-tracking-you-sfri40732/mac) and [Opera](https://help.opera.com/en/latest/security-and-privacy/#tracking).
- Internet Explorer has a feature called [Tracking Protection Lists](https://www.microsoft.com/en-us/iegallery) which allows you to import a list of apps you want to block.
- For more information on how private browsing works as well as its limitations, visit the support pages for your browser: [Microsoft Edge](https://support.microsoft.com/en-gb/help/4026200/windows-browse-inprivate-in-microsoft-edge), [Internet Explorer](https://support.microsoft.com/en-gb/help/17479/windows-internet-explorer-11-change-security-privacy-settings), [Firefox](https://support.mozilla.org/en-US/kb/private-browsing-use-firefox-without-history), [Chrome](https://support.google.com/chrome/answer/95464), Safari ([mobile](https://support.apple.com/en-gb/ht203036) and [desktop](https://support.apple.com/en-gb/guide/safari/browse-privately-ibrw1069/mac)) and [Opera](https://help.opera.com/en/latest/security-and-privacy/#privateWindow).

You may request more information about how we use your data or ask us to delete your data if you are from the EU/UK by contacting us at [hello@artsflow.com](mailto:hello@artsflow.com) and as per our Privacy Policy (opt-out policy).
