    ...
    >
      <SimpleGrid columns={[1, 2]} spacing={10}>
        <VStack>
          ...
          <Box>
            <Text pl={['0', '96px']} pt={['18px', 0]} mt={[0, '-30px']}>
              As a Creative you can create multiple activities on our web app and publish them so
              that people can discover them locally via our mobile app.
            </Text>
          </Box>
        </VStack>
        <VStack>
        ...
        <VStack>
          ...
          <Box>
            <Text pl={['0', '96px']} pt={['18px', 0]} mt={[0, '-30px']}>
              Deliver your arts activities to those that have booked with you locally. Users can
              then review you, save your activity or share with friends.
            </Text>
          </Box>
        </VStack>
        <VStack>
          ...
          <Box>
            <Text pl={['0', '96px']} pt={['18px', 0]} mt={[0, '-30px']}>
              Earn from your passion. Once you’ve delivered your activity you’ll receive your
              payment. You can track your earnings and other metrics via our web app.
            </Text>
          </Box>
        </VStack>
      </SimpleGrid>
